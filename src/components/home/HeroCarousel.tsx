...
export function HeroCarousel({ slides }: { slides: HeroSlide[] }) {
  ...
  return (
    <figure
      className="relative mx-auto w-full min-w-0 max-w-[460px] lg:mx-0 lg:max-w-none"
      onMouseEnter={stop}
      onMouseLeave={play}
    >
      <div className="relative aspect-[1/1.05] w-full min-w-0 overflow-hidden rounded-[20px] shadow-[0_26px_60px_-22px_rgba(20,40,20,0.5)]">
        {slides.map((slide, slideIndex) => (
          <Image
            ...
            sizes="(max-width: 1023px) 460px, 50vw"
      ...
      <div
        className="absolute bottom-7 left-0 flex max-w-[min(240px,calc(100%-1.5rem))] items-center gap-3.5 rounded-2xl bg-white px-5 py-4 shadow-[0_16px_40px_-12px_rgba(0,0,0,0.28)] transition-opacity duration-200 sm:-left-5"
